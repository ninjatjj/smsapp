...
public class LimitedEditText extends EditText {
	 ...
	 * 
	 * @param context
	 *            Context that will display this view.
	 * @param attrs
	 *            Set of attributes defined for this view.
	 * @param defStyle
	 *            Style defined for this view.
	 */
	...
	private void initComponents(AttributeSet attrs) {
		...
		if (attrs != null) // android:maxLength
			maximum_text_size = attrs.getAttributeIntValue("android",
					"maxLength", UNLIMITED);
	...
	/**
	 * Remove text size limit. This will stop drawing the amount of characters
	 * left.
	 */
	 ...
	 * 
	 * @param text
	 *            Text to be drawn on the limit indicator.
